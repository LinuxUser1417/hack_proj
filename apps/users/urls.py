...
from .views import CategoryViewSet, SetShopRating, SetUserRating, ShopProfileView, ShopViewSet, CustomUserViewSet, CustomTokenVerifyView, CustomTokenObtainPairView, CustomTokenRefreshView
